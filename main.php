...
<body id="main">
    ...
    <div id="home" class="flex f-column playfair">
        <div id="homecon">
            <h2 id="midheading">Welcome to Admin Portal</h2>
            <p id="content">Some main services are as follow</p>
            <div id="services" class="flex flex-wrap">
                <div id="components" class="flex f-column">
                    <button id="btncomp" onclick="openInsert()">
                        <img id="imgcomp" src="files/insert.png" alt="">
                        <h2 id="subheading">Insert</h2>
                    </button>
                </div>
                <div id="components" class="flex f-column">
                    <button id="btncomp" onclick="openDelete()">
                        <img id="imgcomp" src="files/delete.png" alt="">
                        <h2 id="subheading">Delete</h2>
                    </button>
                </div>
                <div id="components" class="flex f-column">
                    <button id="btncomp" onclick="openUpdate()">
                        <img id="imgcomp" src="files/update.png" alt="">
                        <h2 id="subheading">Update</h2>
                    </button>
                </div>
                <div id="components" class="flex f-column">
                    <button id="btncomp" onclick="openAcademics()">
                        <img id="imgcomp" src="files/exam.png" alt="">
                        <h2 id="subheading">Academics</h2>
                    </button>
                </div>
                <div id="components" class="flex f-column">
                    <button id="btncomp" onclick="openAttendance()">
