<?php
session_start();
if ($_SESSION['username']=="admin" && $_SESSION['identity']==1) {
    ?>
    <script>
...
elseif ($_SESSION['username'] && $_SESSION['identity']) {
    ?>
    <script>
        ...
        <div id="login" class="rounded-5">
            <div id="log" class="container rounded-5 d-flex flex-column justify-content-center align-items-center">
                <div id="loghead" class="flex flex-column">
                    ...
                    <h1 id="h1" class="m-2">Login</h1>
                </div>
                <form action="indexquery.php" method="post">
